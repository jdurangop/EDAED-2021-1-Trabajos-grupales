...
Pap_fem_sta <- encuesta %>%
  filter(encuesta$Q01_Genero == "2 : Femenino" & encuesta$Q03_Carrera == "3 : EstadÃ­stica")

## Filtro hombres de estadistica.

Pap_mas_sta <- encuesta %>%
  filter(encuesta$Q01_Genero == "1 : Masculino" & encuesta$Q03_Carrera == "3 : EstadÃ­stica")

## Filtro mujeres de Sistemas.

Pap_fem_sis <- encuesta %>%
  filter(encuesta$Q01_Genero == "2 : Femenino" & encuesta$Q03_Carrera == "2 : IngenierÃ­a de sistemas e informÃ¡tica")

## Filtro hombres de Sistemas.

Pap_mas_sis <- encuesta %>%
  filter(encuesta$Q01_Genero == "1 : Masculino" & encuesta$Q03_Carrera == "2 : IngenierÃ­a de sistemas e informÃ¡tica")
...
dt$car_str[dt$Q03_Carrera == "2 : IngenierÃ­a de sistemas e informÃ¡tica"] <- "Ing.Sistemas"
dt$car_str[dt$Q03_Carrera == "3 : EstadÃ­stica"] <- "Estadistica"
dt$car_str[dt$Q03_Carrera == "1 : MatemÃ¡ticas"] <- "Matematicas"
dt$car_str[dt$Q03_Carrera == "4 : IngenierÃ­a administrativa"] <- "Ing.Administrativa"
dt$car_str[dt$Q03_Carrera == "5 : IngenierÃ­a fÃ­sica"] <- "Ing.Fisica"
dt$car_str[dt$Q03_Carrera == "7 : Otra"] <- "Otra"
dt$car_str[dt$Q03_Carrera == "6 : IngenierÃ­a industrial"] <- "Ing.Industrial"
```
