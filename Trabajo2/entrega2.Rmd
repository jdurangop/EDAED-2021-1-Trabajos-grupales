...
plot(prov1$DATE_, prov1$promDown, type = "l",
     frame = FALSE,
     main="Histórico velocidades de subida y bajada\nde Tigo y Movistar",
     xlab = "Fecha",
...
legend("topleft", legend=c("V. Bajada Tigo", "V. Subida Tigo",
                           "V. Bajada Movistar", "V. Subida Movistar"),
